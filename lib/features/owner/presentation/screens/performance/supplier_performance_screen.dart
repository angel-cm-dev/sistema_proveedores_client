        ...
        children: [
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        'Meta: 90% · ${_data.length} proveedores evaluados',
                        style: GoogleFonts.inter(
                          fontSize: 12,
                          color: textSecondary,
                        ),
          ...
          Expanded(
            child: ListView.separated(
              ...
              itemBuilder: (_, i) =>
                  _PerformanceRow(item: _data[i], rank: i + 1, isDark: isDark),
            ),
          ),
        ],
      ),
                  ...
                  child: Center(
                    child: Text(
                      ...
                      style: GoogleFonts.poppins(
                        fontSize: 11,
                        fontWeight: FontWeight.w700,
                        color: rank <= 3 ? AppColors.secondary : textSecondary,
                      ),
                    ),
                  ),
                ),
          ...
          Expanded(
            ...
            child: Text(
              ...
              style: GoogleFonts.inter(
                fontSize: 12,
                fontWeight: FontWeight.w600,
                color: item.incidents > 3 ? AppColors.error : textPrimary,
              ),
              textAlign: TextAlign.center,
            ),
          ),
